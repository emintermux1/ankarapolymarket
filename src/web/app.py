...
def resource_catalog(settings: Settings, source_health: list[SourceHealth] | None = None) -> list[dict[str, Any]]:
    ...
    definitions = [
        ...
        ResourceDef("Open-Meteo ECMWF HRES", "ECMWF 9 km HRES", "Tam çözünürlüklü IFS HRES saatlik sıcaklık, bulut, radyasyon ve rüzgâr modeli.", None, "Open-Meteo ECMWF HRES"),
        ResourceDef("Open-Meteo Previous Runs", "Lead-time backtest", "1-7 gün lead-time geçmiş model koşuları ile bias/skill kalibrasyonu.", None, "Open-Meteo Previous Runs"),
        ResourceDef("MET Norway", "Locationforecast", "Key gerektirmeyen global saatlik forecast; model sepetine bağımsız kontrol.", None, "MET Norway"),
        ...
        ResourceDef("NOAA ISD", "Long LTAC archive", "Esenboğa WMO 17128 hourly arşivi; final fallback ve uzun backtest zemini.", "NOAA_ISD_STATION_FILE", "NOAA_ISD"),
        ...
        ResourceDef("RainViewer", "Radar nowcast", "Ankara radar tile'ları; yağış/konveksiyon nowcast kontrolü.", None, "RainViewer"),
        ResourceDef("EUMETSAT MSG Cloud Mask", "Cloud mask", "SEVIRI cloud mask kataloğu; öğlen radyasyon kırılması kontrolü.", None, "EUMETSAT MSG Cloud Mask"),
        ResourceDef("DWD ICON Open Data", "Raw ICON GRIB", "ICON-EU/ICON ham GRIB kataloğu; Open-Meteo yedeği.", None, "DWD ICON Open Data"),
        ResourceDef("NASA POWER", "Radiation/climate archive", "Gecikmeli radyasyon ve meteorolojik klimatoloji kontrolü.", None, "NASA POWER"),
        ResourceDef("OGIMET", "SYNOP daily summary", "WMO 17128 SYNOP günlük özet formu; manuel/ikincil doğrulama.", None, "OGIMET"),
        ...
        ResourceDef("Windy", "Radar/satellite motion", "Dashboard linklerinde radar ve uydu hareketi.", "WINDY_API_KEY", "Windy"),
        ...
        ResourceDef("WeatherAPI", "Forecast env-ready", "WeatherAPI forecast fallback için env hazır.", "WEATHERAPI_API_KEY", "WeatherAPI"),
