        ...
        return "\n".join(
            [
                ...
                *self._hourly_expectation_lines(model_bundle, analysis.target_date, report_time),
                "",
                f"⚡ Tahmini Sonuç: {_fmt_integer_c(analysis.final_tmax_c)} ({_fmt_c_with_trend(analysis.final_tmax_c, previous_analysis.final_tmax_c if previous_analysis else None)})",
                ...
                "",
                "🤖 Model tahminleri",
                *self._model_digest_lines(model_bundle, analysis, taf, previous_model_tmax_c),
                "",
