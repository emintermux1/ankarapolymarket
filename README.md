...
- Telegram komutları: `/today`, `/aviation` (`/ltac` alias), `/now`, `/metar`, `/taf`, `/models`, `/nowcast`, `/market`, `/edge`, `/backtest`, `/sources`, `/chart`, `/result`
...
python -m src.main nowcast --date 2026-05-24
